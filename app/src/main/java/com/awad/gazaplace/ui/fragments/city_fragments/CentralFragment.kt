...
import com.awad.gazaplace.databinding.FragmentCentralBinding
...
class CentralFragment(val type: String) : Fragment() {
    ...
    private var binding: FragmentCentralBinding? = null
    ...
    override fun onCreateView(
        ...
        city = requireContext().getString(R.string.central)
